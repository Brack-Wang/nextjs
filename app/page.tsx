...
<p className="mt-4">*店家可能要求到场后单独买防滑袜：“Everyone purchasing an ActionTicket or Pass must wear CitySocks. <br />CitySocks are $4.99 and are yours toKeep and re-use”</p>
  <p className="mt-4">*请在Eventbrite报名后，当天23:59前私信管理员Dessi，同时备注Eventbrite报名名字，<br />管理员将告知Zelle信息，否则将取消名额</p>

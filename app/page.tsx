...
export default function Home() {
  ...
  <p>报名链接：<a href="https://www.eventbrite.com/e/861313109697?aff=oddtdtcreator" className="inline-block bg-blue-500 text-white p-2 rounded hover:bg-blue-700 transition duration-300 ease-in-out" target="_blank">报名🔗</a></p>

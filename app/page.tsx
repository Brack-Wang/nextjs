...
{/*   #################################################################################################################### */}
    ...
    <p className="mb-4">☕️小桌主题聊天<br />320 River Bar<br />📍320 N Dearborn St, Chicago, IL 60654<br />Located in: The Westin Chicago River North，从酒店入口进就行！（酒店名：The Westin Chicago River North）<br />（限定报名人数：10人）</p>
    ...
    <h2 className="text-2xl font-bold mb-2">报名成功后的参与者请点单</h2>

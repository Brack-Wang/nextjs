...
{/*   #################################################################################################################### */}
      ...
      <p className="mb-4">WhirlyBall<br />（坐着碰碰车拿着拍子玩球）<a href="https://www.whirlyball.com/" target="_blank" className="text-blue-500 hover:text-blue-700">了解更多</a><br />限定报名人数：14人</p>

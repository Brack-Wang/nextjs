      ...
      <main className="flex min-h-screen flex-col items-center justify-between px-4 sm:p-24">
        <section className="min-h-screen bg-gray-100 p-4 sm:p-8">
            ...
            <div className="mx-auto bg-white shadow-lg rounded-lg p-4 sm:p-6 md:max-w-4xl">
                ...
                <p className="text-base sm:text-lg text-gray-700 mb-4">
               我们每周都会组织各类活动，包括但不限于聊天会、主题分享会，以及Activate、密室逃脱、户外运动等娱乐活动。我们的愿景是打造一个温馨而欢乐的交流平台。让大家在轻松愉快的氛围中交流思想，分享经验，共享资源，从而互相帮助，共同成长。更重要的是，我们希望让每一位疲惫了一周的参与者们在我们愉悦的氛围中重新充电！
                </p>
                <p className="text-base sm:text-lg text-gray-700 mb-4">
               不论你是咖啡爱好者，还是寻求灵感和创意的朋友，或者只是想找个地方放松心情，芝加哥Coffee Chat都欢迎你的加入。让我们一起享受咖啡带来的乐趣，发现更多有趣的灵魂，共同创造美好的回忆吧！
                </p>
